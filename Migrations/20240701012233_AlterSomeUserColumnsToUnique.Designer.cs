...
namespace FoodRestaurantApp_BE.Migrations
{
    ...
    [Migration("20240701012233_AlterSomeUserColumnsToUnique")]
    partial class AlterSomeUserColumnsToUnique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodRestaurantApp_BE.Models.Databases.SystemUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 1, 8, 22, 31, 661, DateTimeKind.Local).AddTicks(5059))
                        .HasColumnName("created_date");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 7, 1, 8, 22, 31, 960, DateTimeKind.Local).AddTicks(1433),
                            Email = "admin@gmail.com",
                            FullName = "Quản trị hệ thống",
                            IsActive = true,
                            Name = "admin",
                            Password = "$2a$11$iPOmu3o8qi24C6pLCpjKGe7dzZI/sTB6rSM1uG2ID4DiKPQD9fMGG",
                            RoleId = 1
                        });
                });
